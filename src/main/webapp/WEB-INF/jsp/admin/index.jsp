...
<link rel="stylesheet" type="text/css" href="/static/css/stylea.css" />
...
<div id="main_container">
    ...
    <div class="right_header">Welcome TA Admin, <a href="#">Visit site</a> | <a href="/ta/logout" class="logout">Logout</a></div>
    <div id="clock_a"></div>
    </div>
    ...
    <div >    
    	<h2 style="display: inline-block; float: left; text-decoration: none;"><a href="/ta/">All Users</a></h2>    	
    </div>                
...
<table id="rounded-corner" summary="Blocked Users">
    <thead>
    	<tr>
            ...
            <th scope="col" class="rounded">Private Key</th>            
        </tr>
    </thead>
        <tfoot>
    	<tr>
    ...
    <tbody>    	
        ...
        <tr>   	 
            ...
            <td><c:out value="${user.privateKey}"/></td>
            <td><a href="/ta/show-user?id=${user.id}"/>Show</a></td>
        </tr>         
        </c:forEach>                
    </tbody>
</table>  
