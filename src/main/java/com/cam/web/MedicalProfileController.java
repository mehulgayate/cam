...
//		User user=userUtility.verifyUser(request.getParameter("auth_token"));
		...
		processMedicalProfile(medicalProfile, threshold,null);
...
//		User user=userUtility.verifyUser(request.getParameter("auth_token"));
	...
	private void processMedicalProfile(UserMedicalProfile medicalProfile, MedicalProfileTheshold threshold,Company company){
